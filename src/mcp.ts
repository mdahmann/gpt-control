...
const CommonSchema = {
	...
	connector_mode: ConnectorModeSchema.describe("prefer selects and verifies connector pills in the assignment; require runs a separate read-only readiness preflight.").optional(),
...
function toRequest(params: Record<string, unknown>, kind: Exclude<RunKind, "subagent" | "image">, prompt: string): StartRequest {
	return {
		...
		connectors: params.connectors as string[] | undefined,
		connectorMode: params.connector_mode as StartRequest["connectorMode"],
