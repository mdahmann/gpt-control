...
const RunSchema = z.object({
	...
	providerActiveDeadlineAt: z.string().optional(),
	...
	diagnostics: z.object({
		...
		providerActiveObservedAt: z.string().optional(),
		providerActiveState: z.string().max(1000).optional(),
	}).optional(),
